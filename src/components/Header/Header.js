        ...
        <header className="app-header">
          ...
          <nav className="page-nav">
            ...
            <ul className="page-nav__links">
              ...
              <li className="page-nav__link"><Link to="/rankings/challenge">Ranking challenge</Link></li>
              <li className="page-nav__link"><Link to="/rankings/routine">Ranking routine</Link></li>
